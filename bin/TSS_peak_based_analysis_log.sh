...
#An example of R code how to inport the count data created above to Seurat object. 
...
#CD4bulk_5sc_TCver_TCRremoved.removeMono.harmonyintegration_FigS14.rds is a file containing Seurat object used in Supplementary figure S14 in the manuscript (Oguchi et al. Scinece)
